...
public final class CppMessageEncoder extends MessageToMessageEncoder<CppMessage> {

	private NettyMarshallingEncoder   marshallingEncoder;
	
	public CppMessageEncoder() {
		this.marshallingEncoder = MarshallingCodeCFactory.buildMarshallingEncoder();
	}

	@Override
	protected void encode(ChannelHandlerContext ctx, CppMessage msg,
